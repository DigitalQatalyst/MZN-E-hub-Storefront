...
export const categoryNavigation = [
  {
    ...
    categoryItem: [
      { icon: "milk", title: "Dariry & Eggs", href: "/product/search/Dariry & Eggs" },
      ...
      { icon: "yogurt", title: "Frozen", href: "/product/search/Frozen" },
      {
        ...
        child: [
          { title: "Pears, apples, quinces", href: "/product/search/Pears, apples, quinces" },
          { title: "Peaches, plums, apricots", href: "/product/search/Peaches, plums, apricots" },
  ...
  },
  {
    ...
    categoryItem: [
      ...
      { icon: "beer", title: "Canned Food", href: "/product/search/Canned Food" },
      { icon: "snack", title: "Coffee & Snacks", href: "/product/search/Coffee & Snacks" },
      { icon: "bottle", title: "Sauces & Jems", href: "/product/search/Sauces & Jems" },
    ],
  },
];
...
export const products = [
...

  {
    ...
    title: "500+ Tailored",
    title1: "Services",
    subTitle: "Explore a curated catalogue of services designed for SMEs-covering funding, training, media exposure, investment opportunities, and much more.",
    brand: null,
    price: 146,
    size: null,
    colors: [],
    discount: 7,
    thumbnail: "/assets/images/Groceries Shop/Frame1.png",
    images: ["/assets/images/Groceries Shop/lime.png", "/assets/images/Groceries Shop/lime.png"],
    categories: [],
    status: null,
    reviews: [],
  ...
  },
  {
    ...
    colors: [],
    discount: 9,
    thumbnail: "/assets/images/Groceries Shop/Frame2.png",
    images: [
      "/assets/images/Groceries Shop/MiniPeppers.png",
      "/assets/images/Groceries Shop/MiniPeppers.png",
    ],
  ...
  },
  {
    ...
    subTitle: "Apply for support, book consultations, and register for programs effortlessly, track your progress through a single, user-friendly platform.",
    brand: null,
    price: 105,
    size: null,
    colors: [],
    discount: 6,
    thumbnail: "/assets/images/Groceries Shop/Frame3.png",
    images: [
      "/assets/images/Groceries Shop/strawberry.png",
      "/assets/images/Groceries Shop/strawberry.png",
    ],
  ...
  },
  {
    ...
    colors: [],
    discount: 7,
    thumbnail: "/assets/images/Groceries Shop/Frame4.png",
    images: ["/assets/images/Groceries Shop/Lemon.png", "/assets/images/Groceries Shop/Lemon.png"],
    categories: [],
    status: null,
    reviews: [],
