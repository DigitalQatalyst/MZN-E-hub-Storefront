...
import { FileIcon, FileTextIcon, ImageIcon, FileSpreadsheetIcon, DownloadIcon, TrashIcon, UploadIcon, XIcon, CheckIcon, AlertCircleIcon, Presentation } from 'lucide-react';
