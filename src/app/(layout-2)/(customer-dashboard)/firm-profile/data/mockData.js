...
const assignFieldStatuses = fields => {
  const statuses = ['locked', 'editable', 'completed'];
  return fields.map(field => ({
    ...field,
    status: field.status || statuses[Math.floor(Math.random() * statuses.length)] // Randomly assign a status
  }));
};

// Add some empty fields to demonstrate placeholder styling
const addEmptyFields = groups => {
...
export const mockProfileData = {
  basic: addEmptyFields([{
    ...
    fields: assignFieldStatuses([{
      ...
      value: "Enterprise software solutions specializing in cloud-based enterprise management systems with AI-driven analytics capabilities. Our flagship products serve various industries including finance, healthcare, and manufacturing."
    }])
  }, {
    ...
    fields: assignFieldStatuses([{
      label: "5-Year Vision",
      value: "To become the leading enterprise software provider in the MENA region, with a focus on AI-driven solutions that transform business operations across industries."
    }, {
      label: "Investment Goals",
      value: "$15M by Q2 2024 (Series B) - 60% complete"
    }, {
      label: "Technology Roadmap",
      value: "2023 Q4: Launch AI analytics platform\n2024 Q2: Expand IoT integration capabilities\n2024 Q4: Develop industry-specific solutions for healthcare\n2025: Blockchain integration for secure transactions"
    }])
  }]),
  contact: addEmptyFields([{
    ...
    fields: assignFieldStatuses([{
      ...
      label: "Email",
      value: "john.smith@futuretech.com"
    }, {
      label: "Phone",
    ...
    fields: [{
      ...
      value: "Level 42, Al Maqam Tower"
    }, {
      label: "Address Line 2",
      value: "ADGM Square, Al Maryah Island"
    }, {
      label: "City",
      value: "Abu Dhabi"
    }, {
    ...
    fields: [{
      ...
      label: "Website",
      value: "www.futuretech.com"
    }, {
      label: "General Email",
      value: "info@futuretech.com"
    }, {
      label: "Support Email",
      value: "support@futuretech.com"
    }, {
      label: "Fax",
      value: "+971 2 123 4568"
    }, {
      label: "Social Media",
      value: "@futuretechllc"
    }]
    ...
    fields: [{
      ...
      label: "Email",
      value: "sarah.johnson@futuretech.com"
    }, {
      label: "Phone",
      value: "+971 50 987 6543"
    }, {
      label: "Nationality",
      value: "American"
    }, {
    ...
    fields: [{
      ...
      label: "Email",
      value: "ahmed.m@futuretech.com"
    }, {
      label: "Phone",
      value: "+971 50 555 1234"
    }, {
  ...
  legal: addEmptyFields([{
    ...
    fields: [{
      ...
      label: "Governing Law",
      value: "ADGM Companies Regulations 2020"
    }, {
    ...
    fields: [{
      ...
      label: "Special Licenses",
      value: "Data Protection Registration"
    }, {
      label: "Compliance Officer",
      value: "Fatima Al Zaabi"
    }, {
    ...
    fields: [{
      ...
      value: "Global Legal Partners LLP"
    }, {
  ...
  financial: addEmptyFields([{
    ...
    fields: [{
      ...
      value: "Trade Finance, Overdraft"
    }, {
      label: "Treasury Services",
      value: "FX, Cash Management"
    }]
  }, {
  ...
  operational: addEmptyFields([{
    ...
    fields: [{
      label: "Key Suppliers",
      value: "5 Tier-1 Suppliers"
    }, {
      label: "Supply Chain Model",
      value: "Just-in-Time"
    }, {
      label: "Procurement Process",
      value: "Digital Procurement Platform"
    }, {
      label: "Average Lead Time",
      value: "14 days"
    }, {
      label: "Supplier Locations",
      value: "UAE, USA, Germany, Singapore"
    }, {
    ...
    fields: [{
      ...
      value: "Cloud-based (AWS, Azure)"
    }, {
      label: "Physical Infrastructure",
      value: "2 Offices, 1 Data Center"
    }, {
      label: "Disaster Recovery",
      value: "Hot Site in Dubai"
    }, {
      label: "Network Capacity",
      value: "10 Gbps Redundant"
    }, {
      label: "Server Environment",
      value: "Virtualized, Containerized"
    }, {
    ...
    fields: [{
      ...
      value: "Digital Process Repository"
    }, {
  ...
  ownership: addEmptyFields([{
    ...
    fields: [{
      ...
      value: "Global Tech Ventures (51%)"
    }, {
      label: "Local Partner",
      value: "Abu Dhabi Investments LLC (24%)"
    }, {
    ...
    fields: [{
      ...
      value: "3-Tier Holding Structure"
    }, {
      label: "Group Organization Chart",
      value: "Updated 05-Mar-2023"
    }, {
    ...
    fields: [{
      ...
      value: "Secondary Share Sale (10%)"
    }, {
      label: "Previous Major Owner",
      value: "Tech Ventures Capital"
    }, {
      label: "Ownership Stability",
      value: "Stable since 2021"
    }, {
    ...
    fields: [{
      ...
      label: "Veto Rights",
      value: "Major Shareholders on Key Decisions"
    }, {
      label: "Dividend Rights",
      value: "Pro-rata to Shareholding"
    }, {
  ...
  licensing: addEmptyFields([{
    ...
    fields: [{
      ...
      label: "License Type",
      value: "Technology Services Provider"
    }, {
    ...
    fields: [{
      ...
      label: "Immigration Establishment",
      value: "ICA-87654321"
    }, {
      label: "Commercial Signage Permit",
      value: "ADM-SG-54321"
    }, {
      label: "Civil Defense Permit",
      value: "CD-2023-12345"
    }, {
      label: "Environmental Permit",
      value: "EAD-2023-7890"
    }, {
      label: "Special Activity Permit",
      value: "ADDED-SA-34567"
    }]
  }, {
    ...
    fields: [{
      ...
      label: "EU GDPR Compliance",
      value: "Registered Data Controller"
    }, {
      label: "ISO 27001 Certification",
      value: "Valid until 15-Jun-2025"
    }, {
      label: "PCI DSS Compliance",
      value: "Level 1 Service Provider"
    }, {
      label: "SOC 2 Type II",
      value: "Annual Audit Completed"
    }, {
    ...
    fields: [{
      ...
      value: "Automated Tracking System"
    }, {
      label: "Compliance Monitoring",
      value: "Quarterly Internal Audits"
    }, {
      ...
      label: "Licensing Budget",
      value: "$125,000 Annual"
    }]
  }]),
  compliance: addEmptyFields([{
    ...
    fields: [{
      ...
      value: "No Major Findings"
    }, {
      label: "Compliance Framework",
      value: "ADGM Compliance Framework"
    }, {
      label: "Regulatory Reporting",
      value: "Quarterly Reports Submitted"
    }]
  }, {
    ...
    fields: [{
      ...
      value: "Digital Contract Repository"
    }, {
      label: "Litigation Status",
      value: "No Active Litigation"
    }, {
      label: "Intellectual Property",
      value: "All IP Properly Registered"
    }, {
      label: "Legal Opinions",
      value: "Clean Legal Opinions on Structure"
    }]
  }, {
    groupName: "Financial Compliance",
    fields: [{
      label: "Anti-Money Laundering",
      value: "AML Program in Place"
    }, {
      label: "KYC Procedures",
      value: "Enhanced Due Diligence for High-Risk Clients"
    }, {
      label: "Financial Reporting",
      value: "IFRS Compliant"
    }, {
      label: "Tax Compliance",
      value: "All Filings Up-to-Date"
    }, {
      label: "Financial Audits",
      value: "Annual External Audit"
    }, {
      label: "Treasury Controls",
      value: "Dual Authorization System"
    }]
  }, {
    groupName: "Industry Compliance",
    fields: [{
      label: "Data Protection",
      value: "ADGM Data Protection Regulations"
    }, {
      ...
      value: "ISO 22301 Compliant"
    }, {
      label: "Industry Standards",
      value: "NIST Cybersecurity Framework"
    }, {
      label: "Technical Compliance",
      value: "TRA Technical Standards"
    }]
  }, {
    groupName: "Compliance History",
    fields: [{
      label: "Regulatory Actions",
      value: "None in Last 5 Years"
    }, {
      ...
      value: "Annual for All Staff"
    }, {
      label: "Whistleblower Reports",
      value: "None in Last 3 Years"
    }]
  }]),
  industry: addEmptyFields([{
    ...
    fields: [{
      ...
      value: "GITEX, Abu Dhabi Technology Week"
    }, {
  ...
  employees: addEmptyFields([{
    ...
    fields: [{
      ...
      value: "22 (18% of workforce)"
    }, {
      label: "Technical Positions",
      value: "75 (63% of workforce)"
    }, {
      label: "Support Positions",
      value: "23 (19% of workforce)"
    }, {
      label: "Remote Workers",
      value: "25 (21% of workforce)"
    }, {
    ...
    fields: [{
      ...
      value: "$2,500 per employee annually"
    }, {
      label: "Employee Turnover",
      value: "8.5% annual"
    }, {
      label: "Succession Planning",
      value: "In place for key positions"
    }]
  }, {
    groupName: "Employment Compliance",
    fields: [{
      label: "Labor Law Compliance",
      value: "ADGM Employment Regulations"
    }, {
      label: "Work Permits Status",
      value: "100% Compliant"
    }, {
  ...
  facilities: addEmptyFields([{
    ...
    fields: [{
      label: "Location",
      value: "Level 42, Al Maqam Tower, ADGM Square"
    }, {
      label: "Size",
      value: "1,500 sq meters"
    }, {
      label: "Capacity",
      value: "150 workstations"
    }, {
      label: "Lease Terms",
      value: "10-year lease, expires 2028"
    }, {
      label: "Facilities",
    ...
    fields: [{
      label: "Dubai Office",
      value: "Dubai Internet City, Building 12"
    }, {
      label: "Size",
      value: "500 sq meters"
    }, {
      ...
      label: "Purpose",
      value: "Sales & customer support"
    }, {
      label: "Lease Terms",
      value: "5-year lease, expires 2025"
    }, {
      label: "Occupancy",
      value: "85% utilized"
    }]
    ...
    fields: [{
      label: "Data Center",
      value: "Khazna Data Center, Masdar City"
    }, {
      label: "Server Room",
      value: "On-premises at HQ (100 sq meters)"
    }, {
    ...
    fields: [{
      ...
      value: "Ibrahim Al Hashemi"
    }, {
      label: "Maintenance Contract",
      value: "Comprehensive with Emrill Services"
    }, {
      label: "Security Provider",
      value: "G4S Secure Solutions"
    }, {
      label: "Health & Safety",
      value: "ISO 45001 compliant"
    }, {
    ...
    fields: [{
      ...
      label: "Facility Strategy",
      value: "Hub and spoke model"
    }, {
  ...
  products: addEmptyFields([{
    ...
    fields: [{
      ...
      label: "CloudSync",
      value: "Cloud data synchronization solution"
    }, {
      label: "SecureID",
      value: "Identity and access management system"
    }, {
      label: "DataInsight",
      value: "Business intelligence and analytics platform"
    }, {
      label: "ProcessFlow",
      value: "Business process automation tool"
    }, {
    ...
    fields: [{
      ...
      value: "24/7 monitoring and management"
    }, {
    ...
    fields: [{
      ...
      value: "AI-enhanced analytics module"
    }, {
      label: "Product Roadmap",
      value: "18-month rolling roadmap"
    }, {
    ...
    fields: [{
      ...
      label: "Customer Base",
      value: "85+ enterprise customers"
    }, {
      label: "Geographic Reach",
      value: "UAE, Saudi Arabia, Qatar, Oman, Kuwait"
    }, {
      label: "Market Share",
      value: "12% in Enterprise Software segment"
    }, {
      label: "Competitive Position",
      value: "Top 3 in UAE market"
    }, {
    ...
    fields: [{
      ...
      value: "Layla Al Mazrouei"
    }, {
      label: "Product Team Size",
      value: "12 professionals"
    }, {
      label: "Product Lifecycle",
      value: "Managed through PLM system"
    }, {
      label: "Customer Feedback",
      value: "NPS score: 67"
    }, {
      label: "Product Performance",
      value: "85% feature adoption rate"
    }, {
  ...
  certifications: addEmptyFields([{
    ...
    fields: assignFieldStatuses([{
      ...
      label: "SOC 2 Type II",
      value: "Service Organization Control"
    }, {
      label: "CSA STAR",
      value: "Cloud Security Alliance"
    }, {
    ...
    fields: assignFieldStatuses([{
      label: "UAE Innovation Award",
      value: "Winner 2022"
    }, {
      label: "Gulf Business Technology Company",
      value: "Top 10 (2021, 2022)"
    }, {
      label: "GITEX Future Stars",
      value: "Best Enterprise Solution 2022"
    }, {
    ...
    fields: assignFieldStatuses([{
      ...
      label: "ITIL Certified Practitioners",
      value: "15 professionals"
    }, {
      label: "Certified Data Scientists",
      value: "6 professionals"
    }])
  }, {
    ...
    fields: assignFieldStatuses([{
      ...
      value: "Specialized Partner"
    }, {
      label: "Gartner Recognition",
      value: "Notable Vendor in MEA, 2022"
    }])
  }])
};
