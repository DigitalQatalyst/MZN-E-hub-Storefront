...
const generalProfileData = {
  businessDescription:
    "FutureTech LLC is a cutting-edge technology consultancy specializing in digital transformation and AI solutions for enterprises.",
  missionStatement:
    "To empower businesses through innovative technology solutions that drive growth and efficiency.",
  visionStatement:
    "To be the leading technology partner for businesses in the MENA region.",
  ...
  clients: [
    {
      name: "ADNOC Digital",
      industry: "Oil & Gas",
      projectValue: "AED 2.5M",
      duration: "18 months",
    },
    {
      name: "Emirates NBD",
      industry: "Banking",
      projectValue: "AED 1.8M",
      duration: "12 months",
    },
    {
      name: "Dubai Municipality",
      industry: "Government",
      projectValue: "AED 3.2M",
      duration: "24 months",
    },
    {
      name: "Etisalat Group",
      industry: "Telecommunications",
      projectValue: "AED 1.5M",
      duration: "15 months",
    },
  ],
...
const competitorsData = {
  directCompetitors: [
    {
      name: "TechMENA Solutions",
      strengths: ["Market presence", "Government contracts"],
      weaknesses: ["Limited AI expertise"],
    },
    {
      name: "Digital Gulf Consulting",
      strengths: ["Large team", "Multiple offices"],
      weaknesses: ["Higher costs", "Slower delivery"],
    },
    {
      name: "Innovation Partners DMCC",
      strengths: ["Dubai focus", "Startup ecosystem"],
...
export default function FirmProfile() {
  ...
  const { firmdata } = useProfileContext();

  // console.log("firm", firmdata?.[0]?.name);
      ...
      content: (
        <Box>
          ...
          <Typography fontSize="14px" color="text.hint" mb="16px">
            {generalProfileData.businessDescription}
          </Typography>
          ...
          <Typography fontSize="14px" color="text.hint" mb="16px">
            {generalProfileData.missionStatement}
          </Typography>
          ...
          <Typography fontSize="14px" color="text.hint" mb="16px">
            {generalProfileData.visionStatement}
          </Typography>
          ...
          <FlexBox flexWrap="wrap" mb="16px">
            {generalProfileData.coreValues.map((value, idx) => (
              <Box
                ...
                mb="8px"
              >
                <Typography fontSize="12px" color="#1976D2">
                  {value}
                </Typography>
              </Box>
            ))}
        ...
        <Box>
          {Object.entries(businessRegistrationData).map(([key, value], idx) => (
            <Box
              ...
              py="10px"
              borderBottom={
                idx < Object.entries(businessRegistrationData).length - 1
                  ? "1px solid #f0f0f0"
                  : "none"
              }
              display="flex"
        ...
        <Box>
          {Object.entries(classificationData).map(([key, value], idx) => (
            <Box
              ...
              py="10px"
              borderBottom={
                idx < Object.entries(classificationData).length - 1
                  ? "1px solid #f0f0f0"
                  : "none"
              }
              display="flex"
        ...
        <Box>
          {Object.entries(referralSourceData).map(([key, value], idx) => (
            <Box
              ...
              py="10px"
              borderBottom={
                idx < Object.entries(referralSourceData).length - 1
                  ? "1px solid #f0f0f0"
                  : "none"
              }
              display="flex"
  ...
  const businessOperationsItems = [
        ...
        <Box>
          {[
            ...
            { label: "Website URL", value: firmData.website },
            {
              ...
              value: firmData.countryOfRegistration,
            },
            ...
            { label: "Postal Code", value: firmData.postalCode },
            {
              ...
              value: firmData.incorporationStatus,
            },
    ...
    },
    {
      ...
      content: (
        <Box>
          <Typography fontSize="14px" fontWeight="600" mb="12px">
            Founders
          </Typography>
          ...
          <Typography fontSize="14px" fontWeight="600" mb="12px" mt="20px">
            Key Team Members
          </Typography>
        ...
        <Box>
          ...
          <FlexBox flexWrap="wrap" mb="16px">
            {businessReachData.targetCustomers.map((customer, idx) => (
              <Box
                ...
                mb="8px"
              >
                <Typography fontSize="12px" color="#7B1FA2">
                  {customer}
                </Typography>
              </Box>
            ))}
          ...
          >
            ...
            <Typography fontSize="14px">
              {businessReachData.geographicReach}
            </Typography>
          </Box>
          ...
          >
            ...
            <Typography fontSize="14px">
              {businessReachData.marketingStrategy}
            </Typography>
          </Box>
          ...
          <FlexBox flexWrap="wrap">
            {businessReachData.clientAcquisitionChannels.map((channel, idx) => (
              <Box
                ...
                mb="8px"
              >
                <Typography fontSize="12px" color="#F57C00">
                  {channel}
                </Typography>
              </Box>
            ))}
        ...
        <Box>
          <FlexBox mb="20px" flexWrap="wrap">
            <Box
              ...
              mb="16px"
            >
              <Typography fontSize="20px" fontWeight="700" color="#1976D2">
                {topClientsData.clientRetentionRate}
              </Typography>
              <Typography fontSize="12px" color="#1976D2">
                Retention Rate
              </Typography>
            ...
            <Box
              ...
              mb="16px"
            >
              <Typography fontSize="20px" fontWeight="700" color="#2E7D32">
                {topClientsData.averageProjectValue}
              </Typography>
              <Typography fontSize="12px" color="#2E7D32">
                Avg Project Value
              </Typography>
            ...
            <Box
              ...
              mb="16px"
            >
              <Typography fontSize="20px" fontWeight="700" color="#7B1FA2">
                {topClientsData.totalActiveClients}
              </Typography>
              <Typography fontSize="12px" color="#7B1FA2">
                Active Clients
              </Typography>
    ...
    },
    {
      ...
      content: (
        <Box>
          ...
          <Typography fontSize="14px" fontWeight="600" mb="8px" mt="20px">
          ...
          <Box p="12px" bg="#E3F2FD" borderRadius="8px">
            <Typography fontSize="12px" fontWeight="600" color="#1976D2">
              Market Position
            </Typography>
            <Typography fontSize="12px" color="#1976D2">
              {competitorsData.marketPosition}
            </Typography>
          </Box>
        </Box>
      ),
            ...
            <Card p="20px" height="fit-content">
              ...
              {[
                ...
                { label: "Employees", value: firmData.employees },
                {
                  ...
                  value: firmData.incorporationType,
                },
                { label: "Website", value: firmData.website },
                { label: "Email", value: firmdata?.[0]?.emailaddress1 },
              ].map((item, idx) => (
                <Box
                  key={idx}
                  py="10px"
