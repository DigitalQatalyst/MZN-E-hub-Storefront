...
export function AllSubmittedReportsPage() {
  ...
  useEffect(() => {
    if (reportData?.submittedReports) {
      setReports(reportData.submittedReports);
      setFilteredReports(reportData.submittedReports);
    }
  }, [reportData]);
      ...
      <div className="bg-gray-50 min-h-screen w-full">
        <div className="container mx-auto p-4 md:p-6 lg:p-8">
          <div className="p-6 pb-2">
            <h1 className="text-2xl font-bold text-gray-900">All Submitted Reports</h1>
            <p className="text-gray-600">Full list of reports you have submitted</p>
          </div>
          <Breadcrumbs />
      ...
      <div className="container mx-auto p-4 md:p-6 lg:p-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          <div className="border-b border-gray-200 p-6">
            ...
            <p className="text-sm text-gray-600">Reports you've filed with regulatory authorities</p>
          </div>
          <div className="p-6">
            {currentReports.length === 0 ? (
              <div className="text-center py-8 bg-gray-50 rounded-xl">
                <p className="text-gray-500">No submitted reports found matching your filters.</p>
              </div>
            ) : (
              <>
                    ...
                    <tbody>
                      {currentReports.map((report, index) => (
                        ...
                        >
                          ...
                          <td className="py-3 px-6">{getStatusBadge(report.status)}</td>
                          <td className="py-3 px-6">
                            <div className="text-sm text-gray-500">{report.submittedDate}</div>
                          </td>
                          <td className="py-3 px-6">
                            <div className="text-sm text-gray-500">{report.reviewer}</div>
                          </td>
