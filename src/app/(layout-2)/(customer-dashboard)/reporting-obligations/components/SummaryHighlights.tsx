...
import { AlertCircleIcon, CheckIcon, ClockIcon, FileTextIcon } from 'lucide-react';
import { SummaryData } from '../types/reporting';

interface SummaryHighlightsProps {
  data?: SummaryData;
}

export function SummaryHighlights({ data }: SummaryHighlightsProps) {
  if (!data) {
    return (
