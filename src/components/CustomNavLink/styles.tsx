...
// ==============================================================
interface StyledCustomNavLinkProps {
  className?: string;
...
const StyledCustomNavLink = styled.span.withConfig({
  shouldForwardProp: (prop: string) => isValidProp(prop)
})<StyledCustomNavLinkProps & SpaceProps & ColorProps>(
...
export default StyledCustomNavLink;
