...
import { ChevronDownIcon, BuildingIcon, CreditCardIcon, NewspaperIcon, UsersIcon, GraduationCapIcon, TrendingUpIcon, CalendarIcon, SparklesIcon } from 'lucide-react';
import Link from 'next/link'; // Add next/link for navigation
import { ComponentType } from 'react'; // Import ComponentType to fix TypeScript error
              ...
              return (
                ...
                >
                  ...
                  <div className="ml-3 flex-1 min-w-0">
                    <p className="text-sm font-medium text-gray-900 truncate">{marketplace.name}</p>
