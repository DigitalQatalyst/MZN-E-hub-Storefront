...
export default function Navbar({ navListOpen }: NavbarProps) {
  ...
  const loginUrl =
    "https://dgqatalyst.b2clogin.com/dgqatalyst.onmicrosoft.com/oauth2/v2.0/authorize?p=B2C_1_KF_SignIn&client_id=b94aa491-036c-4ddb-8bbf-12b510113078&nonce=defaultNonce&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fauth%2Fcallback&scope=openid&response_type=code&prompt=login";
    ...
    <StyledNavbar className={scrolled ? "scrolled" : ""}>
      ...
      >
        ...
        <Box className={`mobile-menu ${menuOpen ? "open" : ""}`}>
          ...
          <FlexBox
            className="mobile-right-section"
