...
export function NotificationsMenu({
  ...
  // Fetch notifications - this would be replaced with GraphQL query to Vendure API
  useEffect(() => {
  ...
  if (loading) {
    return (
      <div className="fixed right-4 top-16 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-40">
    ...
    <div className="fixed right-4 top-16 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-40">
      ...
      <div className="relative z-40">
        ...
        <div className="p-2 border-t border-gray-200">
          <button
            className="w-full text-sm text-blue-600 hover:text-blue-800 p-2 rounded hover:bg-blue-50 flex items-center justify-center"
