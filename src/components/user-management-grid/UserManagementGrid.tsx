  ...
  return (
    <Container>
      ...
      <div style={{ border: "1px solid #ddd", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)" }}>
        <ToolbarWrapper>
          <BaseSelect value={pageSize} onChange={handlePageSizeChange}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px", flexWrap: "wrap" }}>
            ...
            >
              {["All", "Super Admin", "Admin", "Member"].map((role) => (
        ...
        <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", padding: "20px", flexWrap: "wrap" }}>
          <Description>
            Showing {displayedUsers.length} of {users.length} entries
          </Description>
          <Pagination marginTop="0.5rem" pageCount={pageCount} onChange={setCurrentPage} />
        </div>
      </div>
    </Container>
  );
