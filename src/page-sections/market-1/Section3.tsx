...
// Styled wrapper for carousel to ensure proper hover behavior
const CarouselWrapper = styled(Box)`
  width: 100%;
  overflow: hidden;
  position: relative;
  
  /* Ensure carousel navigation buttons appear on hover */
  .carousel-wrapper {
    position: relative;
  }
...
export default function Section3() {
  ...
  // Responsive carousel settings with proper spacing and navigation
  const responsive = [
    {
      breakpoint: 1200,
      settings: {
