  ...
  useEffect(() => {
    ...
    if (category) {
      ...
      const categoryMap: { [key: string]: CategoryFilterKeys } = {
        'business-operations-financing': 'businessOperationsFinancing',
        'project-specialized-financing': 'projectSpecializedFinancing',
        'growth-expansion-financing': 'growthExpansionFinancing',
        'loan-management-adjustments': 'loanManagementAdjustments',
        'business-asset-financing': 'businessAssetFinancing',
        'investment-equity-financing': 'investmentEquityFinancing'
      };
